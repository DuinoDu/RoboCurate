...
已识别的 Three.js、Unitree G1 模型、WARP-RM、HFlow、trajlens、Font Awesome 资源保留各自来源和许可证，见 [第三方说明](THIRD_PARTY_NOTICES.md)。源码包不含私人录像、审核库、浏览器登录状态、模型权重或研究截图。运行时可生成带明显标识的合成 MCAP 试用数据。
